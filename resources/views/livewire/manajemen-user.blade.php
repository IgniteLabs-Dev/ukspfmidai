                    ...
                    <div class="flex-1">
                        ...
                        <div class="relative">
                            ...
                            <input wire:model.live="filter" type="text"
                                placeholder="Masukkan Nama, NIP atau Nomor WA"
        ...
        @elseif($mode == 'edit')
            ...
            <div class="w-full mt-4">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <x-select label="Role" for="role" wire="role" wireType="change"
                            placeholder="Semua role" :options="$options" :required="true" />
                    </div>
                    ...
                    <div>
                        <x-input label="Email" for="email" wire="email" type="email" placeholder="Email" />
                    </div>

                    <div>
                        <x-input label="Password" for="password" wire="password" type="text"

                            ...
                            <td class="px-4 py-4">
                                <div class="flex justify-center">
                                    <img class="h-12 w-20 object-cover rounded-lg shadow-sm border border-gray-200"
                                         alt="cover"
                                         src="{{ asset('files/news/'. $item->cover) }}">
                                </div>
                            </td>
                            <td class="px-4 py-4 text-center">
                                @if ($item->is_published == '1')
                                    <span class="inline-flex px-3 py-1 text-[10px] uppercase tracking-wider font-bold text-white bg-[var(--success)] rounded-full shadow-sm">
                                            Aktif
                                        </span>
                                @else
                                    <span class="inline-flex px-3 py-1 text-[10px] uppercase tracking-wider font-bold text-white bg-[var(--danger)] rounded-full shadow-sm">
                                            Tidak Aktif
                                        </span>
                                @endif
                            </td>

                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                ...
                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-semibold text-white bg-[var(--primary)] border border-gray-300 cursor-default leading-5">
                                    {{ $page }}
                                </span>
                            </span>
                                @else
